...
const EXPECTED_TABLE = [
  ...
  { runtime: 'pi',          installSurface: 'profile-marker-only',  writesSharedSettings: false, finishPermissionWriter: null       },
];
...
describe('writesSharedSettings exclusion equivalence', () => {
  const EXPECTED_FALSE_SET = new Set(['codex', 'copilot', 'kilo', 'cursor', 'windsurf', 'trae', 'cline', 'kimi', 'pi']);
